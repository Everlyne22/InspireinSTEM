...
bt_n = Button(window, text = "CLICK ME!", font = ("Arial", 35), bg = "Violet", fg = "Black", command = top.destroy)  #the word window is where you want the label or the button you want to be placed
bt_n.pack()
